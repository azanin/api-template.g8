lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %% "tapir-http4s-server"            % "0.19.0",
      "com.softwaremill.sttp.tapir" %% "tapir-json-circe"               % "0.19.0",
      "com.softwaremill.sttp.tapir" %% "tapir-openapi-docs"             % "0.19.0",
      "com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml"       % "0.19.0",
