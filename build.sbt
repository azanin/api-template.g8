lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %% "tapir-openapi-docs"             % "0.17.13",
      "com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml"       % "0.17.13",
      "com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s"        % "0.17.13",
