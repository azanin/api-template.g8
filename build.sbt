lazy val root = (project in file("."))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir" %% "tapir-json-circe"               % "0.17.16",
      "com.softwaremill.sttp.tapir" %% "tapir-openapi-docs"             % "0.17.16",
      "com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml"       % "0.17.16",
      "com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s"        % "0.17.16",
      "io.circe"                    %% "circe-generic"                  % "0.13.0",
      "ch.qos.logback"               % "logback-classic"                % "1.2.3" % Runtime,
      "com.codecommit"              %% "cats-effect-testing-scalatest"  % "0.5.2",
