...
lazy val commonSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "org.http4s"                  %% "http4s-blaze-server"           % "0.21.32",
    "com.softwaremill.sttp.tapir" %% "tapir-core"                    % "0.19.4",
    "com.softwaremill.sttp.tapir" %% "tapir-http4s-server"           % "0.19.4",
    "com.softwaremill.sttp.tapir" %% "tapir-json-circe"              % "0.19.4",
    "com.softwaremill.sttp.tapir" %% "tapir-openapi-docs"            % "0.19.4",
    "com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml"      % "0.19.4",
    ...
    "org.http4s"                  %% "http4s-blaze-client"           % "0.21.32",
    "org.http4s"                  %% "http4s-circe"                  % "0.21.32"
  )
)
...
lazy val tests = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.40.1"
    )
  )
